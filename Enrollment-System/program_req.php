...
<body>
	...
	<form method="get" action="program_req.php"> <!-- Form element with GET method to submit data; data is sent to 'program_req.php' -->
	...
	<div id="addForm" style="display:none;">
		...
		<form method="post" action="program_req.php">
	...
	<a href="programcoordinator.php">Go Back to Program Coordinator</a>
	<!-- Provide a link to go back to the Program Coordinator Pannael through 'programcoordinator.php'.-->
</body>
</html>